...
namespace FullCalendar_MVC
{
    ...
    public class ApplicationUserManager : UserManager<Usuario, Guid>
    {
        ...
        {
            var manager = new ApplicationUserManager(new UserStore<Usuario, Grupo, Guid, UsuarioLogin, UsuarioGrupo, UsuarioIdentificacao>(context.Get<AgendaOnlineFc>()));
            ...
            manager.RegisterTwoFactorProvider("Phone Code", new PhoneNumberTokenProvider<Usuario, Guid>
            {
                MessageFormat = "Your security code is {0}"
            });
            manager.RegisterTwoFactorProvider("Email Code", new EmailTokenProvider<Usuario, Guid>
            {
    ...
    public class ApplicationRoleManager : RoleManager<Grupo, Guid>
    {
        ...
        {
            return new ApplicationRoleManager(new RoleStore<Grupo, Guid, UsuarioGrupo>(new AgendaOnlineFc()));
        }
    }
}
