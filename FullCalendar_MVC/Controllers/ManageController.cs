    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ...
            var model = new IndexViewModel
            {
                ...
                PhoneNumber = await UserManager.GetPhoneNumberAsync(new Guid(userId)),
                TwoFactor = await UserManager.GetTwoFactorEnabledAsync(new Guid(userId)),
                Logins = await UserManager.GetLoginsAsync(new Guid(userId)),
